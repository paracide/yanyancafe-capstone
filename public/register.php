      ...
      <div class="input-section">
        ...
        <div class="input-group">
          ...
          <select class="input-field" id="gender" name="gender">
            <option
              value="male" <?= isset($post['gender']) && $post['gender'] == 'male' ? 'selected' : '' ?>>
              Male
            </option>
            <option
              value="female" <?= isset($post['gender']) && $post['gender'] == 'female' ? 'selected' : '' ?>>
              Female
            </option>
            <option
              value="non-binary" <?= isset($post['gender']) && $post['gender'] == 'non-binary' ? 'selected' : '' ?>>
              Non-Binary
            </option>
            <option
              value="unspecified" <?= isset($post['gender']) && $post['gender'] == 'unspecified' ? 'selected' : '' ?>>
              Unspecified
            </option>
          </select>

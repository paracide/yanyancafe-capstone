...
<main>
  <div class="intro" id="intro">
    ...
    <p>
      Eyes of amber, coats of moonlit silk, each whisker holds a tale, an
  ...
  <div class="page" id="xiuxiu-page">
    <div class="page-wrapper border shadow">
      ...
      <p> Xiuxiu is our playful orange who loves to chase anything that moves.
        He's also a big
        fan of cuddles and
  ...
  <div class="page" id="huabi-page">
    <div class="page-wrapper border shadow">
      ...
      <p> He'll observe the goings-on of the cafe with regal indifference,
  ...
  <div class="page" id="ml-page">
    <div class="page-wrapper border shadow">
      ...
      <div class="page-txt">
        <p>Age: 5 years old</p>
        <p>Breed: Ragdoll</p>
        <p>Fur: Brown tabby with white markings on the chest, belly, and
          paws.</p>
        <p>Hobbies: Lounging in sunbeams, chasing toys</p>
      </div>
      <p> He'll greet you with a slow blink and a flick of his tail, then
  ...
  <div class="page" id="pipi-page">
    <div class="page-wrapper border shadow">
      ...
      <div class="page-txt">
        <p>Age: 2 years old</p>
        <p>Breed: Cow</p>
        <p>Fur: Black and white, with a mostly black body and white markings
          on the face, chest, belly, and
          legs</p>
        <p>Hobbies: Playing with toys, climbing furniture</p>
      </div>
      <p> Pipi is our playful cow with a mischievous streak. He'll zip around
        the cafe with
